...
def main():
    ...
    nb_51 = BASE_DIR / "OLD_Stored/5_Synthetic-Data/5.1_Synthetic-Data/Variational-Autoencoder/VAE_Synthetic_Data_Generation.ipynb"
    if nb_51.exists():
    ...
    nb_52 = BASE_DIR / "OLD_Stored/5_Synthetic-Data/5.2_Preprocessing/Preprocessing.ipynb"
    if nb_52.exists():
    ...
    nb_53 = BASE_DIR / "OLD_Stored/5_Synthetic-Data/5.3_Machine-Learning/MiniSom/MiniSom_Machine-Learning.ipynb"
