...
# Add Pipeline_Scripts to path so we can import pipeline_logger
sys.path.append(str(BASE_DIR / "Pipeline_Scripts"))
...
def main():
    ...
    strategies = [
        ...
        },
        {
            ...
            "imputation_nb": "VAE_Imputation_Everything.ipynb", # Assuming this is intended as imputation or creates one
    ...
    preprocessing_nb = BASE_DIR / "OLD_Stored/4_Imputation/4.3_Preprocessing/Preprocessing.ipynb"
    ml_nb = BASE_DIR / "OLD_Stored/4_Imputation/4.4_Machine-Learning-MiniSOM/MiniSom_Machine-Learning.ipynb"

    for strat in strategies:
        print(f"\n--- Strategy: {strat['name']} ---")
        
        # 1. Imputation
        imp_dir = BASE_DIR / "OLD_Stored/4_Imputation" / strat["imputation_dir"]
        ...
        prep_out_dir = BASE_DIR / "OLD_Stored/4_Imputation/4.3_Preprocessing" / strat["output_subdir"]
